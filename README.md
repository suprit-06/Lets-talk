...
- Sliding window context management for optimal OpenAI token usage
...
2. Install dependencies:
   ...
   ```
3. Copy `.env.example` to `.env` and fill in your variables (especially `OPENAI_API_KEY` and `DATABASE_URL`).
